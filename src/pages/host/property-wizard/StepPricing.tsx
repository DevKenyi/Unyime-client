      ...
      {price > 0 && (
        <div className="surface-muted" style={{ padding: '14px 16px', display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12, marginTop: 8 }}>
          <div>
            ...
            <p style={{ fontSize: 18, fontWeight: 800, color: '#111827', margin: 0 }}>₦{guestPays.toLocaleString()}<span style={{ fontSize: 12.5, fontWeight: 500, color: '#6B7280' }}> /night</span></p>
          </div>
          <div>
            <p style={{ fontSize: 11.5, color: '#6B7280', textTransform: 'uppercase', letterSpacing: '0.04em', fontWeight: 700, margin: '0 0 4px' }}>You earn</p>
            <p style={{ fontSize: 18, fontWeight: 800, color: '#095C46', margin: 0 }}>₦{price.toLocaleString()}<span style={{ fontSize: 12.5, fontWeight: 500, color: '#6B7280' }}> /night</span></p>
          </div>
        </div>
      )}
      {price > 0 && (
