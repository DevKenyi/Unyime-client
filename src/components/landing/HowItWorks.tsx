...
const STEPS: { n: string; icon: React.ReactNode; title: string; desc: string; variant: ImageVariant }[] = [
  { n: '01', icon: <Search size={20} />, title: 'Discover', desc: 'Browse beautiful verified properties.', variant: 'apartment-living' },
  { n: '02', icon: <KeyRound size={20} />, title: 'Book', desc: 'Choose your dates and pay securely.', variant: 'apartment-bedroom' },
  { n: '03', icon: <Sparkles size={20} />, title: 'Stay', desc: 'Check in and enjoy your stay.', variant: 'lifestyle-friends' },
]
        ...
        {STEPS.map((step, i) => (
          <Reveal key={step.n} delay={i * 100}>
            <div className="media-zoom" style={{ position: 'relative', borderRadius: 22, marginBottom: 20 }}>
              <PlaceholderImage variant={step.variant} alt={step.title} className="media-zoom__img" style={{ borderRadius: 22, height: 200 }} />
              <div style={{
